...
if __name__=='__main__':
    ...
    rospy.init_node('bag2npy_a1')
    
    # for saving pose
    #subscriber = rospy.Subscriber('/vrpn_client_node/crazyflie1/pose/', PoseStamped, callback)
    
    # for saving error
    subscriber = rospy.Subscriber('/crazyflie1/p_error/', Pose, callback)
    rospy.spin()
