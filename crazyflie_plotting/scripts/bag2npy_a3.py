...
if __name__=='__main__':
    ...
    rospy.init_node('bag2npy_a3')
    
    # for saving pose
    #subscriber = rospy.Subscriber('/vrpn_client_node/crazyflie3/pose/', PoseStamped, callback)
    
    # for saving error
    subscriber = rospy.Subscriber('/crazyflie3/p_error/', Pose, callback)
    rospy.spin()
